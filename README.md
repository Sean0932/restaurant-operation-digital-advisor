...
- 会用 Claude Code、Codex、小龙虾 / OpenClaw 等 agent 的餐饮人。
- 餐饮品牌的老板、运营、财务、供应链负责人。
- 帮餐饮客户做数字化梳理、系统选型、流程诊断的顾问。
- 想免费自查经营链路问题，但不想先被系统销售带着走的人。

不会安装 agent skill 的餐饮老板，可以使用线上产品做完整体检；这个开源版主要给已经会用 agent 的用户免费使用和二次验证。
